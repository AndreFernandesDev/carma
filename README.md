...
- Add active attribute to navbar links based on url.
- Add attribute to expand the navbar.
- Add attribute to add background overlay on scroll to header. (Make bg white on scroll)
